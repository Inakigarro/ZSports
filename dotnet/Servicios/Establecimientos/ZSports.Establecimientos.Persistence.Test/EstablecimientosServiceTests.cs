...
public class EstablecimientosServiceTests
{
    ...
    private Mock<ILogger<EstablecimientosService>> _loggerMock;
    ...
    public void Setup()
    {
        ...
        _loggerMock = new Mock<ILogger<EstablecimientosService>>();
        ...
        _service = new EstablecimientosService(_loggerMock.Object, _unitOfWorkMock.Object);
    }
